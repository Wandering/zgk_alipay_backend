...
public class LoginInterceptor extends HandlerInterceptorAdapter
{
     ...
     * @return
     */
    protected void getUserAccountPojo(String key)
    {
        if (key == null)
        {
            return;
        }
        UserAccountPojo userAccountBean = JSON.parseObject(RedisUtil.getInstance().get(key).toString(), UserAccountPojo.class);
        //对token进行延期
