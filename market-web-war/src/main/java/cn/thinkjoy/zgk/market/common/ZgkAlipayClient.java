...
/**
 * Created by yangguorong on 16/9/28.
 */
public class ZgkAlipayClient implements AlipayClient {
    ...
    public ZgkAlipayClient(String serverUrl, String appId, String privateKey) {
    ...
    public ZgkAlipayClient(String serverUrl, String appId, String privateKey, String format) {
